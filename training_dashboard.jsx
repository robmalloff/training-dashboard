...
const RAW = [
  ...
  {d:"2026-08-18",dist:8.39,mt:2567,type:"Race",re:76,name:"Ottawa - W14 TUE — Threshold Touch 2x2k"},
  {d:"2026-08-19",dist:0.0,mt:2351,type:"Strength",re:27,name:"Strength"},
  {d:"2026-08-20",dist:5.05,mt:1609,type:"Race",re:48,name:"Ottawa Running"},
  {d:"2026-08-22",dist:10.82,mt:5454,type:"Run",re:76,name:"Greater Madawaska Running"},
  {d:"2026-08-26",dist:0.0,mt:2927,type:"Strength",re:33,name:"Strength"},
  {d:"2026-08-27",dist:8.16,mt:2562,type:"Race",re:76,name:"Ottawa Running"},
  {d:"2026-08-28",dist:0.0,mt:2616,type:"Strength",re:30,name:"Strength"},
  {d:"2026-08-30",dist:20.54,mt:6299,type:"Race",re:187,name:"Ottawa - W15 SAT — Army Run Simulation"},
  {d:"2026-09-01",dist:0.0,mt:2804,type:"Strength",re:32,name:"Strength"},
  {d:"2026-09-02",dist:10.22,mt:3075,type:"Race",re:91,name:"Ottawa - W17 TUE — Threshold 2x3km"},
  {d:"2026-09-03",dist:0.0,mt:2262,type:"Strength",re:26,name:"Strength"},
  {d:"2026-09-04",dist:5.04,mt:1595,type:"Race",re:47,name:"Ottawa Running"},
  {d:"2026-09-06",dist:14.39,mt:4834,type:"Race",re:144,name:"Ottawa Track Running"},
  {d:"2026-09-08",dist:5.29,mt:2699,type:"Race",re:80,name:"Ottawa Inline Skating"},
  {d:"2026-09-08",dist:18.09,mt:2379,type:"HIIT",re:46,name:"Indoor Cycling"},
  {d:"2026-09-09",dist:9.24,mt:2742,type:"Race",re:81,name:"Ottawa - W17 TUE — Threshold 2x3km"},
  {d:"2026-09-11",dist:6.97,mt:2192,type:"Race",re:65,name:"Ottawa Running"},
  {d:"2026-09-13",dist:12.43,mt:3642,type:"Race",re:108,name:"Ottawa Running"},
  {d:"2026-09-15",dist:5.94,mt:2065,type:"Race",re:61,name:"Ottawa Running"},
  {d:"2026-09-16",dist:6.22,mt:1864,type:"Race",re:55,name:"Ottawa Running"},
  {d:"2026-09-18",dist:5.07,mt:1562,type:"Race",re:46,name:"Ottawa Running"},
  {d:"2026-09-20",dist:21.38,mt:6132,type:"Race",re:182,name:"Ottawa - W18 SUN — ARMY RUN HALF MARATH"},
  {d:"2026-09-22",dist:16.0,mt:2057,type:"HIIT",re:40,name:"Indoor Cycling"},
  {d:"2026-09-23",dist:6.98,mt:2364,type:"Race",re:70,name:"Ottawa Running"},
      ...
      <div style={{ maxWidth: 760, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 20, paddingBottom: 16, borderBottom: `0.5px solid ${C.border}` }}>
          ...
          <div style={{ textAlign: "right" }}>
            ...
            <div style={{ fontSize: 12, color: C.blue }}>Jan – Sep 2026</div>
          </div>
        </div>
